      ...
      <div className="relative overflow-hidden bg-white">
        ...
        <main className="min-h-screen w-full relative z-10">
          <section className="grid grid-cols-1 justify-items-center justify-center pt-20 ">
            ...
            <span className="pt-3 text-lg lg:text-2xl max-w-[80%] sm:max-w-[50%] text-center text-gray-500">
            ...
            <div className="grid sm:grid-cols-2 gap-3 items-center pt-10">
              ...
              <Button
                ...
                className="
                  border-2 bg-white sm:bg-transparent border-[#6f3096] text-sm font-extralight
                  px-10 py-4
