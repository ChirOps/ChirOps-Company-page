...
return (
  <div className="">
    ...
    <div className="hidden sm:block absolute right-0 top-0 h-96 w-96 translate-x-1/3 -translate-y-1/4 z-0">
      <div className="absolute inset-0 -rotate-12">
    ...
    <div className="hidden sm:block absolute left-0 bottom-0 h-96 w-96 -translate-x-1/3 translate-y-16 z-0">
      <div className="absolute inset-0 rotate-12">
        <div className="h-64 w-64 rounded-3xl border-2 border-purple-600/40" />
      </div>
      <div className="absolute inset-0 -rotate-12 translate-x-8 translate-y-8">
    ...
    <div className=" absolute right-0 bottom-0 h-96 w-96 translate-x-1/3 translate-y-14 z-0">
      <div className="absolute inset-0 -rotate-12">
        <div className="h-72 w-72 rounded-3xl border-2 border-purple-600/40" />
      </div>
      <div className="absolute inset-0 rotate-12 translate-x-8 translate-y-8">
